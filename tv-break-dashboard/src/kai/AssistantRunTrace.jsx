...
const SOURCE_HE = {
  ...
  'restriction preview (scored seam and commit-path optimizer), nothing written': 'תצוגה מקדימה של הגבלה: תמחור מול התוכנית השמורה ומול הרצת אופטימייזר, בלי שנכתב דבר',
  'auth store (roles, affiliations, roster) and the regulatory guardrail register': 'מאגר החשבונות: תפקידים, השתייכות ורשימת החשבונות, ולצידו מרשם מגבלות רישיון השידור',
