...
const WORDS = {
  'console.title': { en: 'Model console', he: 'קונסולת המודל' },
  'console.marker': { en: 'Company side. Training.', he: 'צד החברה. אימון.' },
  'console.back': { en: 'Back to the channel', he: 'חזרה לערוץ' },
  'console.subtitle': {
    en: 'Which gate decided what, on how much contrast, and what a new training would change.',
    he: 'איזה שער הכריע מה, על כמה ניגודיות, ומה אימון חדש היה משנה.',
  },
  ...
  'section.provenance': { en: 'Provenance', he: 'מקורות' },
  ...
  'gates.layers': { en: 'Layers, decided by a person', he: 'שכבות, בהחלטת אדם' },
  'gates.layer_on': { en: 'On', he: 'דלוקה' },
  'gates.layer_off': { en: 'Off', he: 'כבויה' },
  'gates.unblock': { en: 'What would end this', he: 'מה יסיים את זה' },
  ...
  'coverage.blocked': { en: 'Blocked on data we do not have', he: 'חסום על נתונים שאין לנו' },
  'coverage.condition': { en: 'What would unblock it', he: 'מה יפתח את החסימה' },
  ...
  'candidates.title': { en: 'Candidates on the shelf', he: 'מועמדים על המדף' },
  'candidates.subject': { en: 'What it changes', he: 'מה זה משנה' },
  'candidates.gate_deltas': { en: 'Gate differences from the shipped model', he: 'הבדלי שערים מהמודל המשודר' },
  ...
  'candidates.cells_moved': { en: 'cells move', he: 'תאים זזים' },
  'candidates.largest_move': { en: 'largest single move', he: 'התזוזה הגדולה ביותר' },
  'candidates.money': { en: 'Money if adopted', he: 'כסף אם תוטמע' },
  'candidates.not_measured': { en: 'Not measured yet', he: 'טרם נמדד' },
  'candidates.measure': { en: 'Measure it', he: 'למדוד' },
  'candidates.measuring': { en: 'Measuring: the plan is being computed twice', he: 'מודד: התוכנית מחושבת פעמיים' },
  ...
  'candidates.watching': { en: 'This screen keeps reading the measurement until it ends.', he: 'המסך ממשיך לקרוא את המדידה עד שהיא נגמרת.' },
  ...
  'candidates.decide': { en: 'Record a verdict', he: 'רישום הכרעה' },
  'candidates.decide_again': { en: 'Record a new verdict', he: 'רישום הכרעה חדשה' },
  ...
  'candidates.side_shipped': { en: 'shipped', he: 'משודר' },
  ...
  'candidates.no_held_out_moves': { en: 'No held-out figure moves between the two artifacts.', he: 'אף מספר מחוץ למדגם אינו זז בין שני הקבצים.' },
  ...
  'candidates.shipped_records_nothing': { en: 'The shipped artifact records nothing for this gate, so the two cannot be compared on it.', he: 'הקובץ המשודר אינו רושם דבר עבור השער הזה, ולכן לא ניתן להשוות ביניהם עליו.' },
  ...
  'candidates.verdict_not_measured': { en: 'Recorded with no measurement: the money this candidate would move was never measured.', he: 'נרשמה ללא מדידה: הכסף שהמועמד הזה היה מזיז מעולם לא נמדד.' },
  'candidates.verdict_stale': { en: 'An input has moved since that measurement, so the figure the verdict was taken on is superseded.', he: 'קלט זז מאז אותה מדידה, ולכן המספר שעליו התקבלה ההכרעה הוחלף.' },
  ...
  'training.start': { en: 'Train', he: 'לאמן' },
  'training.running': { en: 'Training', he: 'מאמן' },
  'training.overrides': { en: 'Gate overrides', he: 'עקיפת שערים' },
  ...
  'training.writes': { en: 'Writes', he: 'כותב אל' },
  'training.no_runs': { en: 'No training run has been started from this console yet.', he: 'טרם הופעלה הרצת אימון מהקונסולה הזו.' },
  'training.would_change': { en: 'What this run would change', he: 'מה ההרצה הזו הייתה משנה' },
  'training.took': { en: 'took', he: 'ארכה' },
  'training.failed': { en: 'Failed', he: 'נכשלה' },
  'training.done': { en: 'Done', he: 'הסתיימה' },
  'training.watching': { en: 'This screen keeps reading the run until it ends.', he: 'המסך ממשיך לקרוא את ההרצה עד שהיא נגמרת.' },
  ...
  'versions.title': { en: 'Versions and decisions', he: 'גרסאות והכרעות' },
  ...
  'versions.ship': { en: 'Ship it', he: 'להשיק' },
  'versions.no_ship': { en: 'Do not ship it', he: 'לא להשיק' },
  'versions.reason': { en: 'Why', he: 'למה' },
  ...
  'versions.shipped': { en: 'Shipped', he: 'הושקה' },
  'versions.not_shipped': { en: 'Not shipped', he: 'לא הושקה' },
  'versions.escalated': { en: 'Adoption escalated, not performed', he: 'ההטמעה הועברה לאישור, לא בוצעה' },
  'versions.by': { en: 'by', he: 'על ידי' },
  'versions.subject_current': { en: 'the shipped model', he: 'המודל המשודר' },
  'versions.subject_candidate': { en: 'candidate', he: 'מועמד' },

  'provenance.title': { en: 'Provenance', he: 'מקורות' },
  'provenance.artifacts': { en: 'The artifacts and the files they were read from', he: 'הקבצים והמקורות שמהם נקראו' },
  ...
  'provenance.commands': { en: 'The commands that overwrite a shipped artifact', he: 'הפקודות שדורסות קובץ משודר' },
  ...
  'state.loading': { en: 'Reading the artifacts', he: 'קורא את הקבצים' },
  'state.refused': { en: 'This view is company staff only.', he: 'התצוגה הזו שמורה לצוות החברה.' },
  'state.unreachable': { en: 'The server did not answer, so nothing is shown rather than a guess.', he: 'השרת לא ענה, ולכן לא מוצג דבר במקום ניחוש.' },
