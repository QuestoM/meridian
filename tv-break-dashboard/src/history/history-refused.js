...
export const REFUSED_LABELS = {
  ...
  assistant_action: ['Mabat proposal decision refused', 'הכרעת ההצעה של מבט נדחתה'],
  assistant_undo: ['Mabat undo refused', 'ביטול השינוי של מבט נדחה'],
  assistant_upload: ['File to Mabat refused', 'מסירת הקובץ למבט נדחתה'],
  conversation_change: ['Mabat conversation change refused', 'שינוי השיחה עם מבט נדחה'],
  ...
  assistant_context: ['Mabat page read refused', 'קריאת המסך על ידי מבט נדחתה'],
  assistant_ask: ['Question to Mabat refused', 'השאלה למבט נדחתה'],
