...
export const TEXT = {
  ...
  destinationBody: { en: 'Inputs the engine reads now and the reports built from them.', he: 'קלטים שהמנוע קורא כרגע והדוחות שנבנים מהם.' },
  ...
  showRows: { en: 'Preview rows', he: 'תצוגת שורות' },
  ...
  rowsProgress: { en: 'Rows currently shown', he: 'שורות שמוצגות כעת' },
  rowsMore: { en: 'Show the next 20 rows', he: 'הציגו את 20 השורות הבאות' },
  ...
  fields: { en: 'Fields in source details', he: 'שדות בפרטי המקור' },
  fieldsHint: { en: 'Choose which fields appear in each source detail.', he: 'בחרו אילו שדות יוצגו בפרטי כל מקור.' },
