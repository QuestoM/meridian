...
Generated 2026-08-16T00:01:55.799Z. Verdict: **PASS** (0 defect records).
...
Successful duplicate GET groups (460) are informational and are not defects. Request cancellations (0) are recorded separately from failures. Native-wrapper target exceptions: 68. Allowed full-bleed edge contacts: 0.
...
| [plan-objective](./plan-objective/report.json) | 4/4 | 0 | 0 | 0 fail / 12 except | 0 fail / 4 except | 0/0 | 0/0/0 | 0 | 20 | 16 |
| [plan-run](./plan-run/report.json) | 4/4 | 0 | 0 | 0 fail / 0 except | 0 fail / 4 except | 0/0 | 0/0/0 | 0 | 24 | 16 |
| [plan-compare](./plan-compare/report.json) | 4/4 | 0 | 0 | 0 fail / 24 except | 0 fail / 4 except | 0/0 | 0/0/0 | 0 | 24 | 16 |
| [plan-publish](./plan-publish/report.json) | 4/4 | 0 | 0 | 0 fail / 0 except | 0 fail / 4 except | 0/0 | 0/0/0 | 0 | 24 | 16 |
| [plan-supply](./plan-supply/report.json) | 4/4 | 0 | 0 | 0 fail / 0 except | 0 fail / 0 except | 0/0 | 0/0/0 | 0 | 24 | 16 |
| [plan-board](./plan-board/report.json) | 4/4 | 0 | 0 | 0 fail / 0 except | 0 fail / 0 except | 0/0 | 0/0/0 | 0 | 24 | 16 |
...
| [model-candidates](./model-candidates/report.json) | 4/4 | 0 | 0 | 0 fail / 0 except | 0 fail / 0 except | 0/0 | 0/0/0 | 0 | 32 | 16 |
...
Classification ledger: 68 native controls delegate to measured 44px-or-larger wrappers; 0 targets are within the explicit 0.1 CSS-pixel rendering tolerance; 32 low-ratio records belong to inactive controls; 8 final URLs retain the canonical address while adding route-owned selection state. Reduced media retained 364 configured motion-sensitive styles but 0 active nontrivial animations. The 460 duplicate-successful-GET groups contain 504 requests beyond the first; all 0 cancellations are 200-status event streams aborted after use.
...
- Normal configured effects: 0 / 28 / 132 / 200 (136).
- Reduced-motion configured effects: 0 / 17 / 79 / 200 (136).
...
Load-to-capture timing in ms, min / median / p95 / max: 1216 / 1743 / 2171 / 2769 (138). Full records, screenshots, console/network payloads, contrast calculations, target rectangles, font glyph counts and edge insets are in [aggregate.json](./aggregate.json) and each linked route report.
